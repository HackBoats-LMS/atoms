...
export default function ClassesPage() {
    ...
    if (loading) return <div className="p-8">Loading powerteams...</div>;
                ...
                {isCreating && (
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-8">
                        ...
                        <form onSubmit={handleCreateClass} className="space-y-4">
                            ...
                            <button type="submit" className="bg-gray-900 text-white font-bold py-2 px-6 rounded-lg hover:bg-black transition">Save Powerteam</button>
                        </form>
                    </div>
                )}
